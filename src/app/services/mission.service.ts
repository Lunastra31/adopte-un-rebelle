...
import { MissionStatus } from '../models/enums/mission-status';
...
export class MissionService {
  ...
  public affectPilot(pilots: Pilot[], missionId: number): Observable<Mission> {
    return this.httpClient
      .put<Mission>(
        this.url + this.endPoint + 'affect/' + missionId,
  ...
  public endMission(missionId: number, mission: Mission): Observable<Mission> {
    return this.httpClient
      .put<Mission>(
        this.url + this.endPoint + missionId,
