...
import { StarshipStatus } from '../models/enums/starship-status';
...
export class StarshipService {
  ...
  public affectPilot(pilot: Pilot, starshipId: number): Observable<Starship> {
    return this.httpClient
      .put<Starship>(
        this.url + this.endPoint + 'affect/' + starshipId,
  ...
  public desaffectPilot(starshipId: number): Observable<Starship> {
    return this.httpClient
      .put<Starship>(
        this.url + this.endPoint + 'desaffect/' + starshipId,
        {},
        this.httpOptions
      )
      .pipe(
